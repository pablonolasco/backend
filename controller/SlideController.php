...
class SlideController
{
    ...
    static public function ctrMostrarSlide(){
        ...
        $respuesta = SlideModel::mdlMostrarSlide($tabla);
    ...
    static public function ctrCrearSlide($datos){
        ...
        $traerSlide = SlideModel::mdlMostrarSlide($tabla);
        ...
        $respuesta = SlideModel::mdlCrearSlide($tabla, $datos, $orden);
    ...
    static public function ctrActualizarOrdenSlide($datos){
        ...
        $respuesta = SlideModel::mdlActualizarOrdenSlide($tabla, $datos);
    ...
    static public function ctrActualizarSlide($datos){
        ...
        $respuesta = SlideModel::mdlActualizarSlide($tabla, $rutaFondo, $rutaProducto, $datos);
    ...
    public function ctrEliminarSlide(){
        ...
        if(isset($_GET["idSlide"])){
            ...
            $respuesta = SlideModel::mdlEliminarSlide($tabla, $id);
