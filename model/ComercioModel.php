...
class ComercioModel
{
  ...
  =============================================*/
    ...
    public static function obtener_plantilla()
    {
        try{
            $stmt=Conexion::conectar()->prepare("select * from plantilla;");
            $stmt->execute();
            return $stmt->fetch();
            $stmt->close();
            $stmt=null;
    ...
    public static function obtener_comercio()
    {
        try{
            $stmt=Conexion::conectar()->prepare("select * from comercio;");
            $stmt->execute();
            return $stmt->fetch();
            $stmt->close();
            $stmt=null;
