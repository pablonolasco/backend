...
$("#subirLogo").change(function(){
    ...
    /*=============================================
     ...
     =============================================*/
        //Si es diferente de algun formato de foto jpg, png, jpeg
    if(imagenLogo["type"] != "image/jpeg" && imagenLogo["type"] != "image/png"){
        //*limpia input file de la vista
        $("#subirLogo").val("");
        //*Codigo para lanzar alertas
        swal({
        ...
        $.ajax({
            ...
            success: function(respuesta){
                if(respuesta == "ok"){
                    ...
                    swal({
                        title: "Error",
                        text: "¡Ocurrio un error, estamos trabajando en ello.!",
                        type: "error",
                        confirmButtonText: "¡Cerrar!"
                    });
...
$("input[name='colorRedSocial']").on("ifChecked", function(){
    /**
     * FUNCION QUE CREA EL JSON REDES SOCIALES
     * @type {*}
     */
    var color = $(this).val();
    var colorRed = null;
    ...
    for(var i = 0; i < iconos.length; i++){
        //se crea clases de redes sociales de font awesone
