...
$plantilla = ComercioController::get_seleccionar_plantilla();
?>
	...
	<div class="box-body">
		...
		<div class="form-group">
			...
			<p class="pull-right">
				...
				<img src="<?php  echo $plantilla["logoTipo"]; ?>" class="img-thumbnail previsualizarLogo" width="200px">
	...
	<div class="box-body">
		...
		<div class="form-group">
			...
			<p class="pull-right">
				...
				<img src="<?php  echo $plantilla["favIcon"]; ?>" class="img-thumbnail previsualizarIcono" width="50px">
